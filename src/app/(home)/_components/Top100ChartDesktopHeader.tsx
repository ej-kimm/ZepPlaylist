...
const Top100ChartDesktopHeader = () => {
  return (
    <div className={clsx('hidden w-full desktop:block')}>
      <div className={clsx('flex flex-row gap-52 py-3')}>
        <p className={clsx('caption-1 whitespace-nowrap text-[#636363]')}>
          순위
        </p>
        <p className={clsx('caption-1 whitespace-nowrap text-[#636363]')}>
          제목
        </p>
        <p className={clsx('caption-1 whitesapce-nowrap text-[#636363]')}>
          아티스트
        </p>
        <p className={clsx('caption-1 whitesapce-nowrap text-[#636363]')}>
          앨범제목
